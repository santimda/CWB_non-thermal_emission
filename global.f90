module global
   ...
   integer, parameter :: ml = 300      ! spatial resolution for the CD
   ...
   integer, parameter :: n_map_freq = 2! number of radio maps to produce (at the frequencies below) 
   real(dp), parameter :: map_freq(n_map_freq) = (/ 2.3d9, 230.d9 /)
