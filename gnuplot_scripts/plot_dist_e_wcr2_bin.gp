...
set output 'dist_e_wcr2_bin.eps'

plot '../output/dist_e_wcr2_bin.dat' u (log10($2)):(log10((($2)*eV)**2*($3))):1 w l lw 3.0 dt 1 lc palette t '',\
     '../output/dist_e2_total.dat' u (log10($1)):(log10((($1)*eV)**2*($2))) w l lw 3.0 dt 2 lc 0 t 'Total'	 

!./fixbb dist_e_wcr2_bin.eps
